	...
	public class Hany extends JFrame implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
	      ...
	      if(e.getSource()==withdrawButton) {
	  		...
	  		Hany.CreditCard(creditCardAmount1);
	  		}
	      ...
	      if(e.getSource()==balanceButton) {
	    	  JOptionPane.showMessageDialog(null," Your current balance is :  "+Hany.getBalance());
	      ...
	      if(e.getSource()==transferButton) {
			  	...
			  	if(Hany.getBalance()>=depositAmount1) {
			  			
			  		
			  		
			  			Hany.BalanceAfterTransfer(depositAmount1);
				  		...
				  		if(depositAmount3.equals("Mohamed") || depositAmount3.equals("mohamed") ) {
				  			try {
