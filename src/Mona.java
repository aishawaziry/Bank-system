	...
	public class Mona extends JFrame implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
	      ...
	      if(e.getSource()==withdrawButton) {
	  		...
	  		Mona.CreditCard(creditCardAmount1);
	  		}
	      ...
	      if(e.getSource()==balanceButton) {
	    	  ...
	    	  JOptionPane.showMessageDialog(null," Your current balance is :"+Mona.getBalance());
	      ...
	      if(e.getSource()==transferButton) {
	    	  ...
	    	  String depositAmount=JOptionPane.showInputDialog("Enter Transfer Amount");
		  		...
		  		if(Mona.getBalance()>=depositAmount1) {
		  			
		  			
		  			Mona.BalanceAfterTransfer(depositAmount1);
