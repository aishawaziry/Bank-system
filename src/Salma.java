...
public class Salma extends JFrame implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
      ...
      if(e.getSource()==withdrawButton) {
  		...
  		Salma.CreditCard(creditCardAmount1);
  		}
      ...
      if(e.getSource()==balanceButton) {
    	  ...
    	  JOptionPane.showMessageDialog(null,"Your current balance is :"+Salma.getBalance());
      ...
      if(e.getSource()==transferButton) {
    	  ...
    	  String depositAmount=JOptionPane.showInputDialog("Enter Transfer Amount");
	  		...
	  		if(Salma.getBalance()>=depositAmount1) {
	  			
	  			
	  			Salma.BalanceAfterTransfer(depositAmount1);
