	...
	public class Tarek extends JFrame implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
	      ...
	      if(e.getSource()==withdrawButton) {
	  		...
	  		Tarek.CreditCard(creditCardAmount1);
	  		}
	      ...
	      if(e.getSource()==balanceButton) {
	    	  ...
	    	  JOptionPane.showMessageDialog(null,"Your current balance is :"+Tarek.getBalance());
	      ...
	      if(e.getSource()==transferButton) {
	    	  ...
	    	  String depositAmount=JOptionPane.showInputDialog("Enter Transfer Amount");
		  		...
		  		if(Tarek.getBalance()>=depositAmount1) {
		  			
		  			
		  			Tarek.BalanceAfterTransfer(depositAmount1);
